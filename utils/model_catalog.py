...
# example
from policy.torch_model import LinearPPOModel, LinearPPOModelContinuous, LinearPPOModelContinuousV2
...
register_model(LinearPPOModelContinuousV2, "mujoco_model")