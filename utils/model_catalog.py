...
# example
from policy.torch_model import MLPModel, MLPModelContinuous, MLPModelContinuousV2
...
register_model(MLPModel, "example")
register_model(MLPModelContinuous, "cont")
register_model(MLPModelContinuousV2, "mujoco_model")
